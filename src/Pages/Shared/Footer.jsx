...
const Footer = () => {
    ...
    return (
        <div className="grid gap-0 mt-6 max-w-screen-xl">
            <footer className="footer p-10 bg-neutral text-neutral-content">
                ...
                <nav className=" bg-[#1F2937] items-center w-full h-full">
                    <div className="w-full">
                        <h2 className="text-center text-2xl">Follow US</h2>
                        <p className=" text-center">Join us on the social media</p>
